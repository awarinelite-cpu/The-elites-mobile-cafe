  ...
  const startRecording = async () => {
    ...
    try {
      ...
      if (err.name === 'NotAllowedError' || err.name === 'PermissionDeniedError') {
        showToast('❌ Microphone permission denied. Allow access in browser settings.');
            ...
            <div className="msg-chat" style={{ background: 'var(--bg-card)', borderRadius: 12, border: '1px solid var(--border)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
              {!selectedUser ? (
                ...
                <>
                  ...
                  {recording && (
                    <div style={{ padding: '6px 16px', background: 'rgba(239,68,68,0.1)', borderTop: '1px solid rgba(239,68,68,0.2)', display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
                  ...
                  {!audioBlob && (
                    <div style={{ padding: '10px 12px', borderTop: '1px solid var(--border)', display: 'flex', gap: 8, background: 'var(--bg-card)', flexShrink: 0 }}>
                      ...
                      <button onClick={startRecording}
                        ...
                        style={{ ...s.btn(recording ? '#EF4444' : 'var(--bg-secondary)', recording ? '#fff' : 'var(--text-secondary)'), padding: '10px 14px', fontSize: 18, border: `2px solid ${recording ? '#EF4444' : 'var(--border)'}`, flexShrink: 0 }}>
                        {recording ? '⏹' : '🎙️'}
                      </button>
