    ...
    <div style={{ minHeight: '100vh', background: 'var(--dark)', paddingTop: 80 }}>
      ...
      <div style={{ background: 'var(--dark-card)', borderBottom: '1px solid var(--border)', padding: '48px clamp(16px,4vw,60px) 40px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          {/* Back Button */}
          <button onClick={() => navigate(-1)} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'transparent', border: '1px solid var(--border)', borderRadius: 'var(--radius)', padding: '8px 14px', color: 'var(--text-secondary)', fontSize: 13, fontFamily: 'var(--font-body)', cursor: 'pointer', marginBottom: 20, transition: 'var(--transition)' }}
