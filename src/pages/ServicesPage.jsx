...
const SERVICES = [
  {
    ...
    path: '/services/research-projects',
  },
  {
    icon: '📊',
    label: 'Data Analysis',
  ...
  },
  {
    ...
    path: '/services/client-care',
  },
  {
    icon: '📝',
    label: 'Academic Assignments',
    path: '/services/academic-assignments',
  },
  {
    icon: '🖥️',
    label: 'Online Registration',
    path: '/services/online-registration',
  },
  {
    icon: '📑',
  ...
  {
    icon: '🎓',
    label: 'WAEC / NECO Scratch Cards',
    path: '/services/waec-neco',
  },
];
...
export default function ServicesPage() {
  ...
  const handleServiceClick = (path) => {
    // Redirect to login with the intended destination stored in state
...
const styles = {
  page: {
    minHeight: '100vh',
    background: 'linear-gradient(160deg, #0D4F4A 0%, #0D9488 40%, #0F766E 70%, #134E4A 100%)',
    display: 'flex',
    alignItems: 'center',
