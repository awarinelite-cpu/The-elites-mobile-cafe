    ...
    try {
      ...
      if (pendingDraft) {
        await addDoc(collection(db, 'serviceRequests'), {
          ...
          status:       'pending',          // admin sees this as a new request
          createdAt:    serverTimestamp(),
          submittedVia: 'guest-flow',       // so admin knows it came via the public link
        });
        localStorage.removeItem('pendingServiceRequest'); // clean up
